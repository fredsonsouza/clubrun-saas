    ...
    <DropdownMenu modal={false}>
      <DropdownMenuTrigger asChild>
        <Button variant="ghost" size="icon" className="group relative h-9 w-9">
          ...
          <Sun className="dark:-rotate-90 h-[1.2rem] w-[1.2rem] scale-100 text-orange-500 transition-all dark:scale-0" />

          {/* LUA: Invisível no Light (Scale 0), Visível no Dark (Scale 100) */}
          <Moon className="absolute h-[1.2rem] w-[1.2rem] scale-0 text-zinc-100 transition-all dark:rotate-0 dark:scale-100" />
