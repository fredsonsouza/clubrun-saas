    ...
    <div className="min-h-screen bg-gray-50 pb-20 font-sans text-gray-900 selection:bg-orange-500 selection:text-white">
      ...
      <nav className="sticky top-0 z-40 border-b border-gray-200 bg-white">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          {/* Durante a criação do clube, não mostramos menus, apenas o perfil */}
          <MinimalProfileButton />
        </div>
      </nav>

      <main className="animate-in fade-in mx-auto max-w-7xl px-4 pt-12 pb-24 duration-500 sm:px-6 lg:px-8">
