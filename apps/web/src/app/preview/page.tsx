      ...
      <section id="funcionalidades" className="bg-gray-50 py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            {/* Feat 5 */}
            <div className="rounded-3xl border border-gray-100 bg-white bg-gradient-to-br from-gray-900 to-gray-800 p-8 text-white shadow-sm transition-shadow hover:shadow-md lg:col-span-2">
