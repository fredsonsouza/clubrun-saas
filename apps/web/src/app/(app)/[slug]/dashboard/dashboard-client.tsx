        ...
        <div className="mb-8 overflow-hidden rounded-[2.5rem] border border-gray-100 bg-white shadow-xl shadow-gray-200/50">
          ...
          <div className="relative h-48 w-full overflow-hidden sm:h-64">
            ...
            <div className="absolute right-6 bottom-6 left-6 flex items-end justify-between md:right-10 md:bottom-8 md:left-48">
              <div className="flex flex-col gap-1">
                <span className="text-[10px] font-black tracking-[0.2em] text-orange-400 uppercase drop-shadow-sm">
                  PELOTÃO OFICIAL
                </span>
          ...
          <div className="relative flex flex-col items-center justify-between gap-6 px-6 py-8 md:flex-row md:px-10">
            ...
            <div className="mt-12 flex-1 pt-2 text-center md:mt-0 md:pl-38 md:text-left">
              ...
              <div className="mt-4 flex flex-wrap items-center justify-center gap-4 text-[10px] font-black tracking-widest text-gray-400 uppercase md:justify-start">
            ...
            <div className="flex w-full shrink-0 flex-col gap-3 md:w-auto md:flex-row">
              {isMember ? (
                <button
                  ...
                  className="flex cursor-pointer items-center justify-center gap-2 rounded-2xl bg-gray-900 px-8 py-4 text-sm font-black text-white shadow-xl shadow-gray-900/10 transition-all hover:bg-orange-500 hover:shadow-orange-500/20 active:scale-95"
                >
          ...
          <div className="space-y-6 lg:col-span-4">
              ...
              <div className="relative z-10 grid grid-cols-2 gap-3">
                {typeStats.map((stat) => {
                  ...
                  return (
                    ...
                    >
                      <span
                        className={`block text-[10px] font-black tracking-wider uppercase ${config.color} mb-1`}
                      >
                        {config.label}
                      </span>
                      <div className="flex items-baseline gap-1">
                        ...
                        <span
                          className={`text-[10px] font-bold ${config.color} opacity-70`}
                        >
                          TREINOS
                        </span>
                      </div>
            ...
            <div className="relative overflow-hidden rounded-4xl border border-gray-100 bg-white p-6 shadow-sm">
              ...
              <div className="relative z-10 space-y-3">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex flex-col">
                        <span className="line-clamp-1 text-sm font-bold text-gray-900 transition-colors group-hover/member:text-orange-500">
                          {member.name}
                        </span>
                ...
                {members.length > 5 && (
                  <button className="mt-2 w-full cursor-pointer py-2 text-xs font-bold text-gray-400 transition-colors hover:text-gray-600">
            ...
            <div className="relative overflow-hidden rounded-4xl border border-gray-100 bg-white p-6 shadow-sm">
              ...
              <div className="relative z-10 mb-6 flex items-center justify-between">
                ...
                <Link
                  ...
                  className="flex cursor-pointer items-center text-xs font-bold text-orange-500 hover:text-orange-600"
                >
                ...
                {ranking.map((athlete, index) => (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <p
                        className={`truncate text-sm font-bold transition-colors group-hover/ranking:text-orange-500 ${athlete.isMe ? 'text-orange-600' : 'text-gray-900'}`}
                      >
                        {athlete.name}{' '}
                        {athlete.isMe && (
