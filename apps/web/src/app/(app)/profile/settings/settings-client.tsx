...
export function ProfileSettingsClient({ user }: ProfileSettingsClientProps) {
  ...
  const handleUpdatePassword = async (e: React.FormEvent) => {
    ...
    const result = await updatePasswordAction(passwordForm.current, passwordForm.new)
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20 font-sans text-gray-900 selection:bg-orange-500 selection:text-white">
      ...
      <main className="mx-auto max-w-3xl px-4 pt-8 sm:px-6 lg:px-8">
        ...
        <div className="rounded-[2.5rem] border border-gray-100 bg-white p-8 shadow-sm md:p-12">
          <header className="mb-12">
            ...
            <p className="mt-4 text-base font-medium text-gray-500">
              Gerencie as configurações de segurança, privacidade e o encerramento da sua conta.
            </p>
          </header>
          ...
          <div className="space-y-12">
              ...
              <section className="space-y-6">
                ...
                <div className="rounded-3xl border border-gray-50 bg-gray-50/30 p-6">
                  <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                    <div>
                      <h4 className="text-sm font-black text-gray-900">Senha de Acesso</h4>
                      <p className="text-xs font-medium text-gray-500">Mantenha sua conta protegida com uma senha forte.</p>
                    </div>
                    <button 
              ...
              <section className="space-y-6">
                ...
                <div className="rounded-3xl border border-blue-50 bg-blue-50/20 p-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h4 className="text-sm font-black text-gray-900">Autenticação via Google</h4>
                      <p className="mt-1 text-xs font-medium leading-relaxed text-gray-500">
                        Sua conta está protegida pela autenticação do Google. Você não possui uma senha local no Club Run.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <section className="space-y-6">
              ...
              <div className="rounded-[2rem] border border-orange-100 bg-orange-50/30 p-8">
                <div className="flex flex-col justify-between gap-6 sm:flex-row sm:items-center">
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      <span className="rounded-full bg-orange-500 px-3 py-1 text-[10px] font-black text-white uppercase">Plano Premium</span>
                      <span className="text-sm font-bold text-gray-900">Ativo</span>
                    </div>
                    <h4 className="text-xl font-black text-gray-900">Elite Performance</h4>
                    <ul className="mt-4 space-y-2">
                      <li className="flex items-center gap-2 text-xs font-medium text-gray-600">
                        <Check className="h-3.5 w-3.5 text-green-500" /> Acesso a rankings ilimitados
                      </li>
                      <li className="flex items-center gap-2 text-xs font-medium text-gray-600">
                        <Check className="h-3.5 w-3.5 text-green-500" /> Prescrições de treino personalizadas
                      </li>
                    </ul>
                  </div>
                  <Link 
            ...
            <section className="space-y-6 pt-6">
              <h2 className="flex items-center gap-2 text-xs font-black uppercase tracking-widest text-red-600">
              ...
              <div className="space-y-4">
                ...
                <div className="group flex flex-col justify-between gap-4 rounded-3xl border-2 border-transparent bg-gray-50/50 p-6 transition-all hover:border-gray-100 hover:bg-white hover:shadow-xl hover:shadow-gray-900/5 sm:flex-row sm:items-center">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-base font-black text-gray-900">Pausar minha conta</h4>
                      <p className="mt-1 text-sm font-medium text-gray-500 max-w-sm leading-relaxed">
                        Seus dados serão mantidos, mas você perderá acesso às áreas exclusivas de membros.
                      </p>
                    </div>
                  </div>
                  <button 
                ...
                <div className="group flex flex-col justify-between gap-4 rounded-3xl border-2 border-transparent bg-red-50/30 p-6 transition-all hover:border-red-100 hover:bg-white hover:shadow-xl hover:shadow-red-900/5 sm:flex-row sm:items-center">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-base font-black text-red-600">Excluir permanentemente</h4>
                      <p className="mt-1 text-sm font-medium text-gray-500 max-w-sm leading-relaxed">
                        Seus dados pessoais serão anonimizados conforme LGPD. Esta ação é irreversível.
                      </p>
                    </div>
                  </div>
                  <button 
        ...
        {showConfirmDelete && (
          <div className="animate-in fade-in fixed inset-0 z-50 flex items-center justify-center bg-gray-900/60 backdrop-blur-md p-4">
            <div className="animate-in zoom-in-95 w-full max-w-md rounded-[2.5rem] bg-white p-8 shadow-2xl">
              ...
              <h3 className="text-2xl font-black text-gray-900 tracking-tight">Tem certeza absoluta?</h3>
          ...
          <div className="animate-in fade-in fixed inset-0 z-50 flex items-center justify-center bg-gray-900/60 backdrop-blur-md p-4">
            <div className="animate-in zoom-in-95 w-full max-w-md rounded-[2.5rem] bg-white p-8 shadow-2xl">
              <header className="mb-8 flex items-center justify-between">
                <h3 className="flex items-center gap-3 text-2xl font-black text-gray-900 tracking-tight">
              ...
              <form onSubmit={handleUpdatePassword} className="space-y-5">
                ...
                <div className="mt-8 flex gap-3">
                  ...
                  <button 
                    ...
                    className="flex-[1.5] flex items-center justify-center gap-2 rounded-2xl bg-orange-500 py-4 text-sm font-black text-white shadow-lg shadow-orange-500/20 transition-all hover:bg-orange-600 active:scale-95 disabled:opacity-50"
                  >
